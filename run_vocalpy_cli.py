#!/usr/bin/env python
"""No-install launcher for the VocalPy processing CLI.

    conda activate vocalpy
    python run_vocalpy_cli.py single path/to/audio.wav -o vocalpy_output
    python run_vocalpy_cli.py batch path/to/folder -o vocalpy_output
"""
...
from vpgui.cli import main  # noqa: E402
